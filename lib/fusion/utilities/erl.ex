defmodule Fusion.Utilities.Erl do
  @moduledoc "Wrapper around Erlang erl CLI commands."
  ...
  @doc """
  Generate command for invoking an erl node with inet loader.

  ## Examples

      iex> Fusion.Utilities.Erl.cmd_erl_inet_loader(
